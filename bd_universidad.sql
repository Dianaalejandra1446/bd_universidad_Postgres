...
-- DROP TYPE IF EXISTS public.tipo_sexo;
...
-- Table: public.curso_escolar

-- DROP TABLE IF EXISTS public.curso_escolar;
...
(
    ...
    CONSTRAINT departamento_foreign FOREIGN KEY (id_departamento)
        REFERENCES public.departamento (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT persona_foreign FOREIGN KEY (id_profesor)
...
(
    ...
    CONSTRAINT grado_foreign FOREIGN KEY (id_grado)
        REFERENCES public.grado (id_grado) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT profesor_foreign FOREIGN KEY (id_profesor)
...
-- Table: public.alumno_se_matricula_asignatura

-- DROP TABLE IF EXISTS public.alumno_se_matricula_asignatura;
...
(
    ...
    CONSTRAINT asignatura_foreign FOREIGN KEY (id_asignatura)
        REFERENCES public.asignatura (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT curso_escolar_foreign FOREIGN KEY (id_curso_escolar)
        REFERENCES public.curso_escolar (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT persona_foreign FOREIGN KEY (id_alumno)
        REFERENCES public.persona (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
